# ==========================================================
# TOTEM DE RECARGA INTELIGENTE (VERSÃO FINAL COMPLETA)
# ==========================================================
...
def token_valido():
    while True:
        token = input("Digite seu token (6 dígitos): ")
...
if escolha == "s":
    ...
    tempo = numero_positivo("Digite o tempo desejado: ")
...
# ----------------------------------------------------------
# RECARGA (AGORA CORRETA COM HORÁRIO REAL)
# ----------------------------------------------------------
